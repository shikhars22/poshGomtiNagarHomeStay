...
/* --- AWADHI & CORPORATE THEME CONFIGURATION ---
  teal (Leaf/Nature): #a0f0e8 (Tailwind teal-300/teal-300 mix) -> 30% usage
...
const App = () => {
  ...
  const scenarios = [
    ...
    },
    {
      ...
      icon: <Star className="w-8 h-8 text-teal-800" />,
      desc: "Don't put your distinguished guests in a generic glass box. Give them the 'Lucknowi' experience. Our Awadhi-styled interiors and lush tealery impress clients by showing them the true soul of the city, coupled with 5-star comfort.",
  ...
  return (
    <div className="font-sans text-slate-800 bg-stone-50 overflow-x-hidden selection:bg-yellow-300">
      ...
      <nav className={`fixed w-full z-40 transition-all duration-300 ${isScrolled ? 'bg-white/90 backdrop-blur-md shadow-lg py-3' : 'bg-transparent py-6'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            {/* <div className="w-16 h-16 bg-teal-700 rounded-tr-2xl rounded-bl-2xl flex items-center justify-center shadow-md transform hover:scale-105 transition-transform duration-300">
            ...
            <span className={`text-xl md:text-2xl font-bold tracking-tight leading-tight max-w-[150px] md:max-w-none ${isScrolled ? 'text-teal-900' : 'text-white drop-shadow-md'}`}>
        ...
        {/* Mobile Nav Menu */}
        {mobileMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-teal-800 shadow-xl py-6 flex flex-col items-center space-y-6 md:hidden border-t border-teal-700">
      ...
      {/* --- HERO SECTION (teal Theme - 40%) --- */}
      <section className="relative min-h-[90vh] flex items-center justify-center bg-teal-800 overflow-hidden rounded-br-[3rem] md:rounded-br-[5rem] pt-28 pb-16">
        ...
        <div className="absolute top-0 right-0 w-48 h-48 md:w-64 md:h-64 bg-teal-700 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-pulse pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 md:w-96 md:h-96 bg-teal-900 rounded-full mix-blend-multiply filter blur-3xl opacity-50 pointer-events-none"></div>

        <div className="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
          <div className="text-white space-y-8 md:pr-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-900/50 rounded-full border border-yellow-400/30 backdrop-blur-sm shadow-sm">
            ...
            <p className="text-base md:text-xl text-teal-100 max-w-lg leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 pb-4">
              <button 
                ...
                className="px-6 py-3 md:px-8 md:py-3.5 bg-yellow-400 text-teal-900 text-sm md:text-base font-bold rounded-lg shadow-xl hover:bg-yellow-300 hover:scale-105 transition-all flex items-center justify-center gap-2"
              >
          ...
          <div className="relative mt-8 md:mt-0">
            <div className="relative z-8 rounded-2xl overflow-hidden shadow-2xl border-4 border-yellow-400/20 transform rotate-1 hover:rotate-0 transition-transform duration-500">
               ...
               <div className="bg-stone-200 h-64 md:h-96 w-full flex items-center justify-center relative group">
                  ...
                  <img src={familyImg} alt="teal and Yellow Living Room" className="object-cover w-full h-full opacity-40" onError={(e) => {e.target.style.opacity=0; e.target.parentElement.classList.add('bg-stone-200');}} />
                  <div className="text-center p-8 absolute inset-0 flex flex-col items-center justify-center">
                      <Flower size={48} className="text-teal-700 mx-auto mb-4 opacity-50" />
                      <p className="text-teal-800 font-serif text-lg md:text-xl px-4">Visual: Bright living space with indoor plants</p>
                  </div>
               </div>
            </div>
            ...
            <div className="absolute -bottom-6 -left-4 md:-bottom-10 md:-left-10 w-28 h-28 md:w-40 md:h-40 bg-yellow-400 rounded-full z-0 flex items-center justify-center shadow-lg transform rotate-12">
                <div className="text-center transform -rotate-12">
                    <span className="block text-2xl md:text-3xl font-bold text-teal-900">100%</span>
                    <span className="text-[10px] md:text-xs font-bold text-teal-800 uppercase leading-tight">teal<br/>Vibes</span>
                </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="text-center p-2">
                <p className="text-2xl md:text-3xl font-bold text-teal-700">{stat.value}</p>
      ...
      <section id="for-corporates" className="py-20 md:py-24 bg-amber-50 relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            <h2 className="text-teal-800 font-bold tracking-wider uppercase text-xs md:text-sm mb-3">Why Choose Us?</h2>
            ...
            {scenarios.map((item, index) => (
              ...
              >
                ...
                <div className="pt-6 border-t border-slate-100">
                  <p className="text-xs md:text-sm font-bold text-teal-700 flex items-start gap-2">
      ...
      {/* --- THE EXPERIENCE / VISUALS (teal Theme - 40%) --- */}
      <section id="the-experience" className="py-20 md:py-24 bg-teal-900 text-white relative overflow-hidden">
        {/* Decorative Circles - Fixed positioning for mobile to prevent overflow */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] md:w-[800px] md:h-[800px] border border-teal-800 rounded-full pointer-events-none"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] md:w-[600px] md:h-[600px] border border-teal-800 rounded-full pointer-events-none"></div>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center mb-8 md:mb-16">
            <div className="md:w-1/2 text-center md:text-left">
              ...
              <p className="text-teal-100 text-base md:text-lg leading-relaxed">
                ...
                With 40% of our visual theme dedicated to live plants and natural teals, we create an oxygen-rich environment 
            ...
            <div className="md:w-1/2 grid grid-cols-2 gap-3 md:gap-4 w-full">
              <div className="space-y-3 md:space-y-4 md:mt-8">
                <div className="h-32 md:h-48 bg-teal-800 rounded-2xl overflow-hidden relative group">
                   <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-all"></div>
                   <img src={balconyImg} alt="Balcony with Plants" className="object-cover w-full h-full opacity-100" onError={(e) => {e.target.style.opacity=0; e.target.parentElement.classList.add('bg-teal-800');}} />
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                <div className="h-32 md:h-48 bg-teal-700 rounded-2xl overflow-hidden relative group">
                   <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-all"></div>
                <img src={mastersuiteImg} alt="Master Suite" className="object-cover w-full h-full opacity-100" onError={(e) => {e.target.style.opacity=0; e.target.parentElement.classList.add('bg-teal-800');}} />
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div key={idx} className="flex flex-col items-center text-center p-4 md:p-6 bg-white rounded-xl shadow-sm border border-stone-100 hover:shadow-md transition-all group hover:border-teal-200">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-teal-50 text-teal-700 rounded-full flex items-center justify-center mb-3 md:mb-4 group-hover:bg-teal-700 group-hover:text-white transition-colors">
                  {amenity.icon}
                </div>
      ...
      {/* --- CTA / CONTACT (teal/Yellow Split) --- */}
      <section id="contact" className="py-16 md:py-24 relative">
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="bg-teal-800 rounded-3xl p-8 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
            {/* Background Accent */}
            ...
            <div className="flex flex-col md:flex-row justify-center gap-4 md:gap-6 relative z-10">
              <button 
                ...
                className="bg-white text-teal-900 px-8 py-4 rounded-lg font-bold hover:bg-stone-100 transition-colors flex items-center justify-center gap-2 shadow-lg w-full md:w-auto"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="bg-yellow-400 text-teal-900 px-8 py-4 rounded-lg font-bold hover:bg-yellow-300 transition-colors flex items-center justify-center gap-2 shadow-lg w-full md:w-auto"
              >
                <Phone size={20} /> Chat on WhatsApp
              </a>
            </div>
            
            <div className="mt-12 pt-8 border-t border-teal-700/50 text-teal-200 text-sm">
      ...
      {isContactModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-200">
            {/* Modal Header */}
            <div className="bg-teal-800 p-6 flex justify-between items-center">
              <h3 className="text-xl font-bold text-white">Request Corporate Rate Card</h3>
              <button onClick={() => setIsContactModalOpen(false)} className="text-teal-100 hover:text-white hover:bg-teal-700/50 rounded-full p-1 transition-colors">
                <X size={24} />
              </button>
            </div>
            ...
            <div className="p-6 md:p-8">
              <form action="https://formspree.io/f/xgvgzdlo" method="POST" className="space-y-4">
                <div>
                  ...
                  <input type="text" name="name" required className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-teal-600 focus:ring-2 focus:ring-teal-100 outline-none transition-all" placeholder="John Doe" />
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="company" className="block text-sm font-semibold text-slate-700 mb-1">Company Name</label>
                    <input type="text" name="company" className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-teal-600 focus:ring-2 focus:ring-teal-100 outline-none transition-all" placeholder="Acme Corp" />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-sm font-semibold text-slate-700 mb-1">Company Email</label>
                    <input type="email" name="email" required className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-teal-600 focus:ring-2 focus:ring-teal-100 outline-none transition-all" placeholder="john@acme.com" />
                  </div>
                </div>

                <div>
                  <label htmlFor="message" className="block text-sm font-semibold text-slate-700 mb-1">Message</label>
                  <textarea name="message" rows="3" className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-teal-600 focus:ring-2 focus:ring-teal-100 outline-none transition-all resize-none" placeholder="We are looking for accommodation for 3 executives for 1 month..."></textarea>
                </div>

                <button type="submit" className="w-full bg-teal-700 text-white font-bold py-4 rounded-lg hover:bg-teal-800 transition-colors shadow-lg mt-2">
                  Send Message
                </button>
